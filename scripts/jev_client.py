...
SCORE_INSTRUCTIONS = "这个美食候选作为「今晚吃什么」拍板推荐的推荐价值评分（1-10）。"
SCORE_CRITERIA = [
    "1-3 无具体信息：没有店名/菜品名，或明显广告软文，或与地点无关",
    "4-6 提到店或菜但信息单薄：无博主亲测表述、无具体菜品/价格/位置细节",
    "7-8 亲测可信：有具体店名+具体菜品描述+博主多次打卡或本地人视角表述",
    "9-10 亲测可信且有强证据：具体店名+菜品+位置/价格/人气细节（点赞收藏等）齐全",
]
DEFAULT_TIMEOUT = 5.0
